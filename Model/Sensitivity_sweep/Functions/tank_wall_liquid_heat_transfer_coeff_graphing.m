...
function tank_wall_liquid_heat_transfer_coeff_graphing(tank_wall_liquid_heat_transfer_coeff_simOut, liquid_heat_transfer_coeff_vector)
    ...
    for i = 1:length(tank_wall_liquid_heat_transfer_coeff_simOut)
        ...
        = multiple_sim_phase_parsing(tank_wall_liquid_heat_transfer_coeff_simOut(1, i), i);
        ...
        LH2_consumption_vec(i) = Ground_LH2_total(idle_1_index);
            ...
            liquid_heat_transfer_coeff_vector(i) = [0];
        end

    end

    liquid_heat_transfer_coeff_vector_copy = [];
    ...
    for i = 1:length(hose_insulation_sweep_simOut)
        if liquid_heat_transfer_coeff_vector(i) ~= [0]
            liquid_heat_transfer_coeff_vector_copy = [liquid_heat_transfer_coeff_vector_copy, 
                liquid_heat_transfer_coeff_vector(i)];
    ...
    liquid_heat_transfer_coeff_vector = liquid_heat_transfer_coeff_vector_copy;
