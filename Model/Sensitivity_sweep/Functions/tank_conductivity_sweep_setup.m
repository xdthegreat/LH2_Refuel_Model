...
function [tank_conductivity_sweep_simIn, AC_tank_insulation_wm2_vector] = ...
    ...
    AC_tank_insulation_wm2_vector = logspace(log10(1), log10(1200), ...
        AC_tank_equivalent_conductivity_count);
    AC_tank_equivalent_conductivity_vector = AC_tank_insulation_wm2_vector...
        /(Ambient_temp-20)*AC_wall_thickness; % to be changed
