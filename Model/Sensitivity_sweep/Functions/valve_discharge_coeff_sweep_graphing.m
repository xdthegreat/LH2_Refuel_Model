...
valve_discharge_coeff_sweep_results = valve_discharge_coeff_sweep_results';


disp(valve_discharge_coeff_sweep_results)

valve_discharge_coeff_results_table = array2table(valve_discharge_coeff_sweep_results, ...
    'VariableNames', {'Valve discahrge coefficient' 'LH2 consumed warm tank refuel (kg)' ...
