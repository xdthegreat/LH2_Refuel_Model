...
tank_wall_liquid_heat_transfer_coeff_count = 3;
...
clear simIn simOut
 ...
 simIn = tank_wall_liquid_heat_transfer_coeff_simIn;
...
%% plot
tank_wall_liquid_heat_transfer_coeff_graphing(simOut, liquid_heat_transfer_coeff_vector)
